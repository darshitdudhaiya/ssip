...
<?php
    ...
    // print_r($result);
?>
<!-- <img src="../includes/student_login.php" alt=""> -->
<!DOCTYPE html>
<html lang="en-US">
											...
											<div class="row">
												<div class="col-md-5">
													<div class="lp-profile-cover">
														<div class="lp-profile-avatar"><img alt='User Avatar' src='<?= $result['image'] ?>' srcset='<?= $result['images'] ?>' class='avatar avatar-470 photo' height='200' width='200' loading='lazy' /></div>
													</div>
												</div>
													...
													<div class="lp-profile-info">
														...
														<div class="author-social-networks">
															<div class="inner">
																...
																<a class="hint--bounce hint--top hint--primary" aria-label="Pinterest" href="#" target="_blank">
																	<i class="fab fa-pinterest"></i>
																</a>

																<a class="hint--bounce hint--top hint--primary" aria-label="Youtube" href="#" target="_blank">
																		...
																		<div class="elementor-element elementor-element-f280b51 elementor-widget elementor-widget-tm-heading" data-id="f280b51" data-element_type="widget" data-widget_type="tm-heading.default">
																			<div class="elementor-widget-container">
																				<div class="tm-modern-heading">
																					...
																					<div class="heading-primary-wrap">
																						<h2 class="heading-primary elementor-heading-title">Explore</h2>
																					</div>
		...
		<div class="inner">
			...
			<div class="page-mobile-menu-content">
				<ul id="mobile-menu-primary" class="menu__container">
																						...
																						<div class="elementor-widget-container">
																							<div class="elementor-image">
																								<a href="#" target="_blank" rel="nofollow">
																									<img width="600" height="257" src="../images/homepages-mega-menu-image-alt.jpg" class="attachment-full size-full" alt="" loading="lazy" srcset="../images/homepages-mega-menu-image-alt.jpg 600w, ../images/homepages-mega-menu-image-alt.jpg 300w" sizes="(max-width: 600px) 100vw, 600px" /> </a>
																							</div>
																						</div>
																					</div>
																				</div>
					...
					<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-97 level-1"><a href="../../courses/index.html">
							<div class="menu-item-wrap"><span class="menu-item-title">Courses</span><span class="toggle-sub-menu"> </span></div>
						</a>
						<ul class="sub-menu children simple-menu">
							...
							<li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item menu-item-1539"><a href="index.html">
									<div class="menu-item-wrap"><span class="menu-item-title">Profile</span></div>
								</a></li>
					...
					<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1652 level-1"><a href="../../blog/index.html">
							<div class="menu-item-wrap"><span class="menu-item-title">Blog</span><span class="toggle-sub-menu"> </span></div>
						</a>
						<ul class="sub-menu children simple-menu">
