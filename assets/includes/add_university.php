                                    ...
                                    <div class="learn-press-form-wrap learn-press-form-register-wrap col-md-6 col-md-push-3">
                                        ...
                                        <div class="learn-press-form-register learn-press-form">
                                            ...
                                            <form name="learn-press-register" method="post" action="<?= urlOf('assets/codes/add_school_code.php') ?>" enctype="multipart/form-data">
                                                <ul class="form-fields">
                                                    <li class="form-field">
                                                        <label for="reg_name">University Name&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="s_name" type="text" placeholder="Enter School name : " autocomplete="email" value="" required>
                                                    </li>
                                                    
                                                    <li class="form-field">
                                                        <label for="reg_username">Email address&nbsp;<span>*</span></label>
