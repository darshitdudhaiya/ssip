                                ...
                                <?php foreach ($result as $ans) { ?>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="#" target="_self"><button id="delete-btn">Delete</button></a></td>
                                        </tr>
                                    </tbody>
                                <?php } ?>
                                                                                ...
                                                                                <div class="tm-modern-heading">
                                                                                    ...
                                                                                    <div class="heading-description-wrap">
                                                                                        <div class="heading-description">
                                                                                            &copy; 2020 CZMGC. All Rights Reserved </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
        ...
        <div class="inner">
            ...
            <div class="page-mobile-menu-content">
                <ul id="mobile-menu-primary" class="menu__container">
                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-14 level-1 has-mega-menu"><a href="https://maxcoach.thememove.com/">
                            <div class="menu-item-wrap"><span class="menu-item-title">Home</span><span class="toggle-sub-menu"> </span></div>
                        </a>
                        <ul class="sub-menu children mega-menu">
                    ...
                    <li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-1652 level-1"><a href="../blog/index.html">
                        ...
                        <ul class="sub-menu children simple-menu">
                            <li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-831 current_page_item menu-item-860"><a href="index.html">
