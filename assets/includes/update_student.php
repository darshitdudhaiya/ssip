                                            ...
                                            <form name="learn-press-register" method="post" action="<?= urlOf('assets/codes/add_student_code.php') ?>" enctype="multipart/form-data">
                                                <ul class="form-fields">
                                                    ...
                                                    <li class="form-field">
                                                        ...
                                                        <input id="school_name" name="sc_name" type="text" autocomplete="name" value="<?= $result['sc_name'] ?>">
                                                    </li>
                                                    <li class="form-field">
                                                    ...
                                                    <li class="form-field">
                                                        ...
                                                        <input id="a_number" name="a_number" type="number" placeholder="Enter Alternate Number : " autocomplete="number" value="">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="aadhar">Adharcard Number&nbsp;<span>*</span></label>
                                                        <input id="aadhar" name="adhar" type="text" placeholder="Enter Adharcard Number : " autocomplete="number" value="<?= $result['a_number'] ?>">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="class">Select Your Class&nbsp;<span>*</span></label>
                                                        <input list="class" id="class" name="class" value="<?= $result['class'] ?>">
                                                        <datalist id="class">
 ...
 -->
    ...
    <script>
        $("#update").click(function(e) {
            ...
            $.ajax({
                url: "/ssip/assets/includes/update_query.php",
                type: 'POST',
                ...
                data: JSON.stringify({
                    ...
                    fathers_occ: $("#fathers_occ").val(),
                    mothers_occ: $("#mothers_occ").val(),
                    email: $("#email").val(),
                    dob: $("#dob").val(),
                    b_groop: $("#b_groop").val(),
                    number: $("#number").val(),
