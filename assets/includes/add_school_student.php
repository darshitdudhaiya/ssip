                                ...
                                <div class="learnpress">
                                    ...
                                    <div class="learn-press-form-wrap learn-press-form-register-wrap col-md-6 col-md-push-3">
                                        ...
                                        <div class="learn-press-form-register learn-press-form">
                                            ...
                                            <form name="learn-press-register" method="post" action="<?= urlOf('assets/codes/add_student_code.php') ?>" enctype="multipart/form-data">
                                                <ul class="form-fields">

                                                    <li class="form-field">
                                                        <label for="reg_name">School Name&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="sc_name" type="text" autocomplete="name" value="<?= $result['s_name'] ?>">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_name">SLMS No &nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="slms_no" type="number" autocomplete="name" placeholder="SLMS No : ">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_name">SLMS Passwrod &nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="sc_name" type="password" autocomplete="name" placeholder="SLMS Password : ">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_name">Student Name&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="stud_name" type="text" placeholder="Surname Name Fathers-name : " autocomplete="email" value="">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_name">Fathers Name&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="f_name" type="text" placeholder="Surname Name Fathers-name : " autocomplete="email" value="">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_name">Mothers Name&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="m_name" type="text" placeholder="Surname Name Husbands-name : " autocomplete="email" value="">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_name">Fathers Occupation&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="f_occupation" type="text" placeholder="Enter Fathers Occupation : " autocomplete="email" value="">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_name">Mothers Occupation&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="m_occupation" type="text" placeholder="Enter Mothers Occupation : " autocomplete="email" value="">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_name">Email&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="email" type="email" placeholder="Enter your Email : " autocomplete="email" value="">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_email">Date of Birth&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="dob" type="date" placeholder="Enter University Email : " autocomplete="email" value="">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Blood Group&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_username" name="blood" type="text" placeholder="Enter Date of Birth :  " autocomplete="number" value="">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Number&nbsp;<span>*</span></label>
                                                        <input id="reg_username" name="number" type="number" placeholder="Enter Number : " autocomplete="number" value="">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Alternate Number&nbsp;<span>*</span></label>
                                                        <input id="reg_username" name="a_number" type="number" placeholder="Enter Alternate Number : " autocomplete="number" value="">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Adharcard Number&nbsp;<span>*</span></label>
                                                        <input id="reg_username" name="adhar" type="number" placeholder="Enter Adharcard Number : " autocomplete="number" value="">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Select Your Class&nbsp;<span>*</span></label>
                                                    ...
                                                    <li class="form-field">
                                                        ...
                                                        <input id="reg_username" name="remarks" type="text" placeholder="Remarks : " autocomplete="number" value="">
                                                    </li>
                                                    <li class="form-field">
                                                    ...
                                                    <li class="form-field">
                                                        ...
                                                        <input type="text" name="district" value="<?= $result['district'] ?>">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Select Your Board&nbsp;<span>*</span></label>
                                                        <input type="text" name="board" value="<?= $result['board'] ?>">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Upload Student Image&nbsp;<span>*</span></label>
                                                        <input id="reg_username" name="image" type="file" placeholder="Upload Student Image : " autocomplete="number" value="">
                                                    </li>
                                                </ul>
                                                <p>
